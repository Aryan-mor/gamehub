...
const registerBowlingHandlers = (bot) => {
    ...
    bot.callbackQuery(/^bowling_play_again_.*/, async (ctx) => {
        try {
            const userInfo = (0, telegramHelpers_1.extractUserInfo)(ctx);
            const callbackData = ctx.callbackQuery.data || '';
            (0, logger_1.logFunctionStart)('bowlingPlayAgainCallback', { userId: userInfo.userId, callbackData });
            await (0, telegramHelpers_1.answerCallbackQuery)(bot, ctx.callbackQuery.id);
            ...
            (0, logger_1.logFunctionEnd)('bowlingPlayAgainCallback', { success: true }, { userId: userInfo.userId });
        }
        catch (error) {
            (0, logger_1.logError)('bowlingPlayAgainCallback', error, {});
