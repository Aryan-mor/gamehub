...
export { advancedRouter };
export const register = (route: string, handler: Handler) => advancedRouter.register(route, handler);
export const registerModule = (modulePath: string, handler: (messageKey: string, context: HandlerContext) => Promise<void>) => advancedRouter.registerModule(modulePath, handler);
export const dispatch = (messageKey: string, context: HandlerContext) => advancedRouter.dispatch(messageKey, context);
export const getRoutes = () => advancedRouter.getRoutes();
export const getRouteInfo = () => advancedRouter.getRouteInfo(); 