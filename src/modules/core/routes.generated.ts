  ...
  "games": {
    ...
    "poker": {
      ...
      "room": {
        ...
        "raise": "games.poker.room.raise",
        "ready": "games.poker.room.ready",
        "show-cards": "games.poker.room.show-cards",
